...
<body>
  <div style="text-align:center;">
    ...
    <hr>
    <button class="btn" id="start_calibrate" onclick="sendCmd('start_calibration','1')">Start Calibration </button><br>

    <hr>
    <input type="number" id="cal_distance" placeholder="Cal_Distance"><br>
    <button class="btn" id="calibrate" onclick="sendCmd('calibrate',document.getElementById('cal_distance').value)">Calibrate </button><br>
